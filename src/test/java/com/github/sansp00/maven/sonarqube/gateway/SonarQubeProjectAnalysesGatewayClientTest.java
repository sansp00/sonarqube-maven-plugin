...
public class SonarQubeProjectAnalysesGatewayClientTest {
	...
	public void getAll() throws SonarQubeGatewayException {
		...
		Mockito.when(webTarget.queryParam(SonarQubeProjectAnalysesGatewayClient.PROJECT_KEY, GatewayModelBuilder.PROJECT_KEY))
		...
		ProjectAnalysesSearchResponse projectAnalysesSearchResponse = gatewayClient.search(GatewayModelBuilder.PROJECT_KEY,
				Category.QUALITY_PROFILE, null, null);
