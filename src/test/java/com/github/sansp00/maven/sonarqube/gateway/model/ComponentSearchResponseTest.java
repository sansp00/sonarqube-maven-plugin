...
public class ComponentSearchResponseTest {
	@Test
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = ComponentSearchResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/ComponentSearchResponse.json");

		// Act
		ComponentSearchResponse response = objectMapper.readValue(jsonData, ComponentSearchResponse.class);
