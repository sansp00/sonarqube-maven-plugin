...
public class ProjectAnalysesSearchResponseTest {
	@Test
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = ProjectAnalysesSearchResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/ProjectAnalysesSearchResponse.json");

		// Act
		ProjectAnalysesSearchResponse response = objectMapper.readValue(jsonData, ProjectAnalysesSearchResponse.class);
