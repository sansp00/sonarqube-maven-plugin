...
public class ProjectCreateResponseTest {
	...
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = ProjectCreateResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/ProjectCreateResponse.json");

		// Act
		ProjectCreateResponse response = objectMapper.readValue(jsonData, ProjectCreateResponse.class);
