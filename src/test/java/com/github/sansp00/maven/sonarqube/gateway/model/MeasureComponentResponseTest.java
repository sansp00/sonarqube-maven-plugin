...
public class MeasureComponentResponseTest {
	@Test
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = MeasureComponentResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/MeasureComponentResponse.json");

		// Act
		MeasureComponentResponse response = objectMapper.readValue(jsonData, MeasureComponentResponse.class);
