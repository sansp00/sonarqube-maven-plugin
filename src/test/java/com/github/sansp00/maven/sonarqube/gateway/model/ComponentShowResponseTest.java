...
public class ComponentShowResponseTest {
	@Test
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = ComponentShowResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/ComponentShowResponse.json");

		// Act
		ComponentShowResponse response = objectMapper.readValue(jsonData, ComponentShowResponse.class);
