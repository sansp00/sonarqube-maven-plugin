...
public class MeasureSearchHistoryResponseTest {
	@Test
	public void testPojo() {
		// Arrange
		final Class<?> classUnderTest = MeasureSearchHistoryResponse.class;
	...
	public void testMapper() throws JsonParseException, JsonMappingException, IOException {
		...
		final String jsonData = FileUtils.fileRead("src/test/resources/gateway/MeasureSearchHistoryResponse.json");

		// Act
		MeasureSearchHistoryResponse response = objectMapper.readValue(jsonData, MeasureSearchHistoryResponse.class);
